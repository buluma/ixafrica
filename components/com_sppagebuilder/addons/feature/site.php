...
class SppagebuilderAddonFeature extends SppagebuilderAddons {
	...
	public function render() {
		...
		$feature_text .= $text;
		if (!empty($title_url)) {
		$feature_text .= '<div class="addon-link-box">';
			$feature_text .= '<a class="addon-link pull-right '.$title_link_color.'" href="'.$title_url.'">';
			$feature_text .= 'View More';
			$feature_text .= '</a>';
			$feature_text .= '</div>';
		}
		$feature_text .= '</div>';

		// $feature_text  = '<div class="sppb-addon-link">';
		// $feature_text .= $title_url;
		// $feature_text .= '</div>';
